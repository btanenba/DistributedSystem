...
public class ClientMasterThread1 extends Thread {
	...
	public ClientMasterThread1(Socket clientSocket, Shared share) {
	...
	public void run() {
		System.out.println("Created Connection and Entering ClientMasterThread ");
		...
		while (true) {
			...
			if (rnd.nextInt() < 0.50) {
				...
				ATask taskA = new ATask(request, 1);
				int x = 0;
				do {
				...
				BTask taskB = new BTask(request, 1);
				do {
